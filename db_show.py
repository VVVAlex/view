...
from common import bakdir, font, font_size, load_image_tk, load_image       # create_images,
...
class Editor:
    ...
    def __init__(self, master=None, parent=None):
        ...
        im_print = load_image('print2.png', 'print.png')
        im_close = load_image('delete2.png', 'delete3.png')
        im_pdf = load_image('pdf2.png', 'pdf.png')
        ...
        btn_cancel = ctk.CTkButton(
            f_btn,
            text="Отмена",
            image=im_close,                     # self.img.delete3,
        ...
        self.btn_pdf = ctk.CTkButton(
            ...
            fg_color="transparent",
            cursor="hand2",
            command=lambda: self.db_show(1),
        )
        self.btn_pdf.pack(side=tk.RIGHT, fill=tk.X, expand=False, padx=(5, 5))
        self.btn_print = ctk.CTkButton(
            f_btn,
            text="Печать",
            image=im_print,                     # self.img.print,
            text_color=("gray10", "gray90"),
            width=115,
            height=30,
            border_width=2,
            ...
            fg_color="transparent",
            cursor="hand2",
            command=lambda: self.db_show(0),
        )
        self.btn_print.pack(side=tk.RIGHT, fill=tk.X, expand=False)
        btn_cancel.pack(side=tk.RIGHT, fill=tk.X, expand=False, padx=5, pady=0)

    def db_show(self, verbose, arg=None) -> None:
...
class ViewMetka:
    ...
    def __init__(self, parent, result, geom=None):
        ...
        self.result = result
        bg_color = parent._apply_appearance_mode(ctk.ThemeManager.theme["CTkFrame"]["border_color"])
        ...
        self.top_w = CTkTop(title='Просмотр меток', font=("Roboto Medium", -16), border_width=2,
